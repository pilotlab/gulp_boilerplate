module mshell
{
    ...
    */
    ...
    export class SignalBinding<T> {
        ...
        */
        constructor(signal: Signal<T>, listener, isOnce: boolean, listenerContext: any, priority: number = 0) {
        ...
        */
        isBound(): boolean { return (!!this._signal && !!this._listener); }

        /**
        * @return {boolean} Will SignalBinding be executed only once?
        */
        isOnce(): boolean { return this._isOnce; }
        ...
        */
        getSignal(): Signal<T> { return this._signal; }
